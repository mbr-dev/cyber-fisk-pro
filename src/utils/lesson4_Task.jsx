export const L4_T1_Facil = [
  ...
  },
  {
    ...
    resposta: [
      ...
      {label: "singer", status: 0},
      {label: "sister", status: 1}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "grandmother", status: 0},
      {label: "grandfather", status: 0}
    ]
  },
  {
  ...
  },
  {
    ...
    resposta: [
      ...
      {label: "daughter", status: 1},
      {label: "sister", status: 0}
    ]
  },
  {
...
export const L4_T1_Medio = [
  {
    ...
    resposta: [
      ...
      {label: "He’s my teacher.", status: 0},
      {label: "He´s my bother.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "They are my friends.", status: 1},
      {label: "They are friends.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "This is my aunt.", status: 0},
      {label: "These are pets.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "Your house is pretty.", status: 0},
      {label: "Our mom is pretty.", status: 1}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "These are siblings.", status: 0},
      {label: "They are sisters.", status: 0}
    ]
  },
  {
  ...
  },
  {
    ...
    resposta: [
      ...
      {label: "She is my aunt.", status: 1},
      {label: "She’s my mom.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "She’s from Italy.", status: 0},
      {label: "She likes Italy.", status: 0}
    ]
  },
  {
  ...
  },
  {
    ...
    {label: "They are in the classroom.", status: 1},
      {label: "They’re in the classroom.", status: 0},
      {label: "They’re in the room.", status: 0}
    ]
  }
]
...
export const L4_T1_Dificil = [
  {
    ...
    resposta: [
      ...
      {label: "He’s my friend.", status: 0},
      {label: "He’s from New York.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "She is at school.", status: 0}
    ]
  },
  {
    pergunta: "L4_Task1_D_2",
    resposta: [
      {label: "He’s talented.", status: 0},
      {label: "He’s my teacher.", status: 1},
      {label: "He’s a good-looking guy.", status: 0},
      {label: "He’s in Miami.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "They are famous.", status: 0},
  ...
  },
  {
    ...
    resposta: [
      ...
      {label: "He’s in Argentina.", status: 1},
      {label: "We are in Miami.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "She’s at home.", status: 0},
      {label: "I like celebrities.", status: 0}
    ]
  },
  {
  ...
  },
  {
    ...
    resposta: [
      ...
      {label: "She’s at school.", status: 0},
      {label: "My siblings are happy.", status: 0},
      {label: "They’re at home.", status: 1}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "They’re at school.", status: 0},
      {label: "She’s a pretty soccer player.", status: 0}
    ]
  },
  {
    ...
    resposta: [
      ...
      {label: "She’s in Los Angeles.", status: 1},
      {label: "They are in the restaurant.", status: 0}
    ]
  }
]
