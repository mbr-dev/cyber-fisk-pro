...
import { Container, Main, Dollars, Game, Ranking, Wheel, Top, Buttons, BottomArea, Inside } from "./styles";
...
export const Help = () => {
  ...
  return (
    <Container>
      <TopMenuHeader title="Help" />

      <Main>
        <Buttons>
          <Ranking onClick={() => setShowR(!showR)} style={{
          ...
          <Dollars onClick={() => setShowD(!showD)} style={{
          ...
          <Game onClick={() => setShowG(!showG)} style={{
          ...
          <Wheel onClick={() => setShowW(!showW)} style={{
        ...
        <BottomArea>
          <LineSeparator bg={defaultTheme["gray-200"]} w="18rem" mb="0" mt="0" />
          <ButtonBg
            title="Home"
            w="14rem"
            h="2rem"
